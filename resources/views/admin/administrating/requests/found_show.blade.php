        ...
        <div class="row">
                ...
                <div class="panel panel-visible" id="spy5">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span class="glyphicon glyphicon-tasks"></span>Картка загубленої тварини
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="created_at" name="created_at" class="form-control"
                                           value="{{ old('created_at') ?? ($animal->created_at ? $animal->created_at->format('d-m-Y H:i') : '')}}"
                                           disabled>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" id="updated_at" name="updated_at" class="form-control"
                                           value="{{ old('updated_at') ?? ($animal->updated_at ? $animal->updated_at->format('d-m-Y H:i') : '')}}"
                                           disabled>
                                </div>
                            </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-visible" id="spy5">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span class="glyphicon glyphicon-tasks"></span>Затвердження
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-visible" id="spy6">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span class="glyphicon glyphicon-tasks"></span>Опрацювання
                        </div>
                    </div>
                    <form class="form-horizontal">
                        <div class="panel-body">
            ...
            @if(count($animal->images))
                <div class="col-md-12">
                    <div class="panel panel-visible" id="spy5">
                        <div class="panel-heading">
                            <div class="panel-title">
                                <span class="glyphicon glyphicon-tasks"></span>Фото знайденої тварини
                            </div>
                        </div>
                                    ...
                                    @foreach($animal->images as $image)
                                        <div class="file-item">
                                            <a href="/{{ $image->path }}">
                                                ...
                                                <div class="file-name">{{ $image->filename }}
                                                    .{{ $image->fileextension }}</div>
                                            </a>
                                        </div>
                                    @endforeach
